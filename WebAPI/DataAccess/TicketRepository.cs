   ...
   public List<Tickets> GetAllTicket()
   {
    ...
    public List<Tickets> GetReimbursementByAuthor(string author)
    {
      ...
      while(reader.Read())
        ...
        public Tickets GetReimbursementById(int id)
     {
         throw new ResourceNotFoundException();
     }
      public List<Tickets>  GetReimbursementByStatus(string status)
    {
      Tickets foundTickets;
      SqlConnection conn = _connectionFactory.GetConnection();
      conn.Open();
     ...
     public Tickets CreateReimbursement(Tickets newTicketsToRegister)
     {
        ...
        try
        {
             ...
             if (tax != 0)
             {
                ...
                {
                    return CreateReimbursement(newTicketsToRegister);
                }
                else
                {
